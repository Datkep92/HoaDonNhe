...
(async () => {
  ...
  const notes = [
    ...
    '',
    'Bạn **không cần tải gì**: mở HoaDonNhe, app sẽ báo có bản mới và tự tải + xác minh SHA-256 rồi',
    'tự thay chương trình và khởi động lại. Setup chỉ dùng cho lần cài đầu tiên (hoặc repair/gỡ cài đặt).',
    '',
